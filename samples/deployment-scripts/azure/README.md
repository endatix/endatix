...
- Runtime secrets and first admin credentials: generated by script into `parameters.production.bicepparam`
- Hub build-time values: `endatix-hub/.env.production` (build-only public keys, generated)
...
- `parameters.production.bicepparam` (merged secure parameter file, generated from `parameters.bicepparam`)
...
Why generate `parameters.production.bicepparam`?
...
- `endatix-hub/.env.production` (build-only Hub values such as `NEXT_PUBLIC_*`)
