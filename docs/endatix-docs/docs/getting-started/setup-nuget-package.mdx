...
description: Install and configure Endatix in your .NET Core project via NuGet, including package setup, appsettings configuration, and initial startup.
---
...
Before getting started, make sure your environment meets the [System Requirements](/docs/getting-started/system-requirements) (.NET 10 SDK, a supported database, and `pg_trgm` when using PostgreSQL). NuGet Package Manager is included with Visual Studio or the .NET CLI.
