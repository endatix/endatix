...
description: Understand the design principles, layered architecture, and core components of the Endatix platform for .NET and SurveyJS projects.
---
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl("/img/diagrams/solution_architecture_light.jpg"),
    dark: useBaseUrl("/img/diagrams/solution_architecture_dark.jpg"),
  }}
/>
