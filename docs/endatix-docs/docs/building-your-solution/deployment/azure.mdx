...
Do you prefer a containerized local sandbox? Check out our [Docker Setup Guide](https://github.com/endatix/endatix/blob/main/docs/endatix-docs/docs/guides/docker-setup.mdx).
:::
