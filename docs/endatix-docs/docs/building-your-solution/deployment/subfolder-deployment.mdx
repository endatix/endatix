...
description: Configure Endatix Hub and API URLs when one or both applications are served under path prefixes.
sidebar_position: 3
---
...
For the required proxy headers and `Endatix:Hosting` API settings, you must read the [Reverse Proxy Deployment](/docs/building-your-solution/deployment/reverse-proxy-deployment.mdx) guide in conjunction with this page.
...
```env
ENDATIX_BASE_URL=[https://yourdomain.com](https://yourdomain.com)
