...
description: Set up and customize authentication for Endatix - including the built-in JWT provider and external providers like Google OAuth and Keycloak.
sidebar_position: 1
---
...
Session secrets and Keycloak/Google client env: [Hub environment variables](/docs/developers/hub/environment).
