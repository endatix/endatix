---
title: Authorization
description: Configure authorization in Endatix - understand RBAC, set up role-based access with Keycloak, and control which roles can access which resources.
sidebar_position: 2
---
...
- `submissions.create.onbehalf` - Create submissions on behalf of other users (for form prefilling)
...
- See [API Permissions Reference](/docs/guides/api-permissions-reference) for a complete mapping of endpoints to required permissions
