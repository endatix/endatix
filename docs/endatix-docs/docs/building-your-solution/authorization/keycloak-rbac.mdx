---
title: Keycloak RBAC
description: Set up role-based access control for Endatix using Keycloak - covers realm roles, client scopes, JWT token introspection, and permission mapping.
sidebar_position: 1
---
