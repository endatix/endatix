...
<img src={require('./localization-overview-elements.webp').default} className="legacy-screenshot" width="600" alt="Example of a localized form interface" />
<br />
<br />
...
<img src={require('./localization-overview-default.webp').default} className="legacy-screenshot" width="400" alt="Default language" />
<br />
...
<img src={require('./localization-overview-selector.webp').default} className="legacy-screenshot" width="300" alt="Language selector" />
<br />
...
<img src={require('./localization-overview-preview-selector.webp').default} className="legacy-screenshot" width="300" alt="Preview language selector" />
<br />
<br />
