...
1. Set `"questionsOnPageMode": "inputPerPage"` within the survey JSON configuration or select the **“Single input field per page”** mode in the **Navigation** section of the **Property Grid**:
