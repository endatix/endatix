...
<img src={require('./question-loops-navigation-mode.webp').default} className="legacy-screenshot" width="453" alt="Form navigation settings" />
<br />
<br />
...
<img src={require('./question-loops-dynamic-panel-settings.webp').default} className="legacy-screenshot" width="453" alt="Dynamic panel settings" />
...
<img src={require('./question-loops-property-grid.webp').default} className="legacy-screenshot" width="453" alt="Question loops configuration in the Property Grid" />
...
In the Title or Description of any question inside your Dynamic Panel, use the placeholder `{panel.itemText}`.

* **Example Title:** "How often do you use **`{panel.itemText}`**?"  
...
{  
  ...
  "templateElements": [  
    {  
      "type": "rating",  
      "name": "quality_rating",  
      "title": "How would you rate the quality of {panel.itemText}?"  
    },  
    {  
      "type": "comment",  
      "name": "feedback_text",  
      "title": "Tell us more about {panel.itemText}:"  
    }  
  ]  
}
```
