...
The `regexMatch` function tests whether a question value matches a regular expression pattern. Use it in `visibleIf`, `enableIf`, and other conditional expressions when you need regex-based show/hide or enable/disable logic beyond native question validators.
