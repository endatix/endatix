...
<ThemedImage
  ...
  sources={{ light: OverviewLight, dark: OverviewDark }} className="legacy-screenshot"
/>
...
<ThemedImage
  ...
  sources={{ light: SectionsLight, dark: SectionsDark }} className="legacy-screenshot"
/>
...
<ThemedImage
  ...
  sources={{ light: SurveyJsLight, dark: SurveyJsDark }} className="legacy-screenshot"
/>
