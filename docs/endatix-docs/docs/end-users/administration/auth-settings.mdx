---
title: Auth Settings
description: Understand how the Endatix API and the Endatix Hub authentication configuration are split and reviewed safely in Platform Admin.
sidebar_position: 2
---

import ThemedImage from "@theme/ThemedImage";
import OverviewLight from "./auth-settings-overview_light.png";
import OverviewDark from "./auth-settings-overview_dark.png";
...
3. Under **Configuration**, choose **Auth**.

<ThemedImage
  alt="Auth Settings showing API authentication, Hub sign-in, and platform admin approval"
