...
<ThemedImage
  alt="Email Settings showing provider status, templates, and Send Test Email" className="legacy-screenshot"
...
<img
  src={require('./email-settings-templates.webp').default} className="legacy-screenshot"
