...
description: Understand platform-level administration, tenant settings, and external identity provider approval in the Endatix Form Management system.
sidebar_position: 1
---
...
- Platform administrators
- Storage, [email](/docs/end-users/administration/email-settings), and authentication configuration status
- [Environment](/docs/end-users/administration/environment) — Hub runtime env audit (API, analytics, reCAPTCHA, SurveyJS licence presence, debug)
