...
Logging is covered in full by **[Observability](/docs/configuration/observability)**, which documents log levels,
...
naming it. See the [migration table](/docs/configuration/observability#migrating-from-the-serilog-section).
:::
