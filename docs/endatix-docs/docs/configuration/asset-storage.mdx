...
:::info[Two configs]
**Hub** signs browser uploads from Hub env (`STORAGE_*`). The **API** rewrites export URLs and fetches submission files using `Endatix:Storage`. See [Hub environment variables](/docs/developers/hub/environment) and [Storage Settings](/docs/configuration/settings/storage-settings).
:::
...
* [Hub environment variables](/docs/developers/hub/environment)
* [Endatix API Storage Settings](/docs/configuration/settings/storage-settings)