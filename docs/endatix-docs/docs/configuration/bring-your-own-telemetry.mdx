...
See [Observability](/docs/configuration/observability) for a self-hosted collector configuration.
...
- [Observability](/docs/configuration/observability) — the OTLP contract, log levels, file logging and the local
  dashboard
