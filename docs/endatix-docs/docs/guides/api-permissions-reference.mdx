...
description: A complete reference of all Endatix API endpoints and their required permissions - essential for configuring external authorization and RBAC.
sidebar_position: 5
---
