...
vi.mock('@/features/my-account/application/actions/change-password.action', () => ({
...
describe('ChangePasswordForm', () => {
  ...
  it('displays validation errors for empty fields', async () => {
    ...
    expect(await screen.findByText(/current password is required/i)).toBeDefined();
    expect(await screen.findByText(/new password is required/i)).toBeDefined();
    expect(await screen.findByText(/confirm password is required/i)).toBeDefined();
  });
  ...
  it('displays success message on successful password change', async () => {
    ...
    expect(await screen.findByText(/Your password has been changed successfully/i)).toBeDefined();
  });
