...
>(({ submissionId, formId, status, variant = 'outline', onClick, ...props }, ref) => {
...
export { SubmissionStatusButton as ChangeStatusButton, type SubmissionStatusButtonProps as ChangeStatusButtonProps };
