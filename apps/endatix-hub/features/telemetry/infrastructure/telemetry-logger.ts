...
export class TelemetryLogger {
   ...
   */
  static debug(message: string, attributes?: LogAttributes, loggerName?: string): void {
   ...
   * @param loggerName Logger name
   */
  static info(message: string, attributes?: LogAttributes, loggerName?: string): void {
   ...
   * @param loggerName Logger name
   */
  static warn(message: string, attributes?: LogAttributes, loggerName?: string): void {
