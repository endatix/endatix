 ...
 */
const comingSoonMessage: string = "We are working hard to provide great features to you. Stay tuned. Great stuff is on the way!";
 ...
 */
export const showComingSoonMessage = (event: React.MouseEvent<HTMLElement>, messageOverride?: string) => {
