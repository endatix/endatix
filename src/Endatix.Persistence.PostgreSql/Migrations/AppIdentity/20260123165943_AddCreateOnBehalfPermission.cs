    ...
    public partial class AddCreateOnBehalfPermission : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                VALUES (1439907347219611800, 'submissions.create.onbehalf', 'Permission: submissions.create.onbehalf', 'submissions', TRUE, TRUE, NOW(), FALSE);
            ");
            ...
            migrationBuilder.Sql(@"
                ...
                VALUES (1439907347219611801, 1439907347219611687, 1439907347219611800, NOW(), TRUE, NOW(), FALSE);
            ");

            // 3. Add permission to Creator role (RoleId = 1439907347219611688)
            migrationBuilder.Sql(@"
                INSERT INTO identity.""RolePermissions"" (""Id"", ""RoleId"", ""PermissionId"", ""GrantedAt"", ""IsActive"", ""CreatedAt"", ""IsDeleted"")
                VALUES (1439907347219611802, 1439907347219611688, 1439907347219611800, NOW(), TRUE, NOW(), FALSE);
            ");
        }
