...
public interface ISubmissionExportRepository
{
    ...
    /// </summary>
    /// <typeparam name="T">The type of export row</typeparam>
    ...
    IAsyncEnumerable<T> GetExportRowsAsync<T>(long formId, string? sqlFunctionName, CancellationToken cancellationToken) where T : class;
}