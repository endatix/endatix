...
public sealed class List(
    IMediator mediator)
    : Endpoint<DataListsListRequest, Results<Ok<Paged<IEnumerable<DataListModel>>>, ProblemHttpResult>>
{
    /// <summary>
    ...
    public override async Task<Results<Ok<Paged<IEnumerable<DataListModel>>>, ProblemHttpResult>> ExecuteAsync(DataListsListRequest request, CancellationToken ct)
    {
