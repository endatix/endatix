...
namespace Endatix.Modules.Jobs.Persistence.Migrations.PostgreSql
{
    ...
    [Migration("20260916042651_RemoveResultJsonFromBackgroundJobs")]
    partial class RemoveResultJsonFromBackgroundJobs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Endatix.Modules.Jobs.Domain.BackgroundJob", b =>
                {
                    ...
                    b.ToTable("BackgroundJobs", "jobs", t =>
                        {
                            t.HasCheckConstraint("CK_BackgroundJobs_TenantId", "\"TenantId\" > 0");
                        });
                });
