...
public class FormSchemaProviderTests
{
    ...
    [Fact]
    public async Task GetOrCompileAsync_WithCurrentSchema_ReturnsWithoutInvokingProcessor()
    {
    ...
    [Fact]
    public async Task GetOrCompileAsync_WithStaleSchema_InvokesProcessorAndReturnsRefreshedSchema()
    {
    ...
    [Fact]
    public async Task GetOrCompileAsync_WhenProcessorDoesNotProduceMatchingSchema_ReturnsNull()
    {
        IFormExportSchemaRepository schemaRepository = Substitute.For<IFormExportSchemaRepository>();
        schemaRepository.GetByFormIdAsync(TenantId, FormId, Arg.Any<CancellationToken>())
            .Returns(
